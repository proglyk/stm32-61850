...
//typedef err_t (*netif_ethoutput_fn)(struct netif* netif, struct pbuf* p, 
//	const struct eth_addr* src, const struct eth_addr* dst, u16_t eth_type);
typedef err_t (*netif_linkoutput_fn)(struct netif *netif, struct pbuf *p, void * argv);
/** Function prototype for netif status- or link-callback functions. */
typedef void (*netif_status_callback_fn)(struct netif *netif, void * argv);
...
#if LWIP_DHCP
  SemaphoreHandle_t sig_dhcp_addr_assgnd;
	SemaphoreHandle_t sig_dhcp_addr_assgnd2;
	SemaphoreHandle_t sig_sntp_ok;
#endif /*LWIP_DHCP*/
	SemaphoreHandle_t sig_set_mmsvalue;
...
void netif_set_link_up(struct netif *netif, void * argv);
void netif_set_link_down(struct netif *netif, void * argv);
/** Ask if a link is up */
